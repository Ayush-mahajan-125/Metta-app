...
const Modules = () => {
    return (
        <section>
            <div className="msm-module-page-block">
                <div className="msm-mt-5 container pb-5 ">
                    ...
                    <div className="text-center py-5">
                        <h1 className="text-white-heading fw-bold mb-3  text-uppercase ">
                            Course Modules
                        </h1>
                        <p className="lead text-light h6 fw-normal text-uppercase">
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-3 col-xl-3 mt-4">
                            <div className='card px-2 msm-bg-color py-2 lw-card-color'>
                                <summary className='text-center text-white fw-bold p-3 text-uppercase'>Module 1 <br /> <small className='text-light msm-font-size'>( Basic To Advanced )</small></summary>
                                <button type="button" class="btn-toggle-collapse" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                    <b className='text-center msm-text-color-text text-white'>Chapter 1</b> <br /> Technical Analysis
                                </button>
                                ...
                                <span className='text-center msm-text-color-secondary fw-bold my-2'>------(OR)------</span>
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-4">
                            <div className='card msm-bg-color px-2 py-2 lw-card-color'>
                                <summary className='text-center text-white fw-bold p-3 text-uppercase '>Modules 2 <br /> <small className='text-light msm-font-size '>( Advanced Pro Plus )</small></summary>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-dark">
                                                ...
                                                <ol>
                                                    <h4>1. Futures Market Foundation</h4>
                                                    <ul>
                                                        <li>Futures Contract Specifications</li>
                                                        <li>Margin System (SPAN + Exposure Margin)</li>
                                                        <li>Mark-to-Market (MTM)</li>
                                                        <li>Cost of Carry Model</li>
                                                        <li>Futures Fair Value</li>
                                                        <li>Relationship with Interest Rates & Dividends</li>
                                                    </ul>

                                                    <h4>2. Advanced Futures Trading Strategies</h4>
                                                    <ul>
                                                        <li>Long / Short Futures (Directional)</li>
                                                        <li>Hedging with Futures</li>
                                                        <li>Cash-Futures Arbitrage</li>
                                                        <li>Spread Trading</li>
                                                        <li>Calendar Spread</li>
                                                        <li>Inter-Commodity Spread</li>
                                                        <li>Pair Trading</li>
                                                    ...
                                                    <h4>3. Open Interest & Volume Analysis</h4>
                                                    <ul>
                                                        <li>OI Basics</li>
                                                        <li>Long Buildup</li>
                                                        <li>Short Buildup</li>
                                                        <li>Long Unwinding</li>
                                                        <li>Short Covering</li>
                                                        <li>Volume + OI Correlation</li>
                                                        <li>OI Shift Analysis</li>
                                                        <li>OI Based Support & Resistance</li>
                                                    </ul>

                                                    <h4>4. Volatility Analysis</h4>
                                                    <ul>
                                                        <li>Historical Volatility (HV)</li>
                                                        <li>Implied Volatility (IV)</li>
                                                        <li>IV vs HV</li>
                                                        <li>India VIX Analysis</li>
                                                        <li>IV Rank & IV Percentile</li>
                                                        <li>Volatility Smile & Skew </li>
                                                        <li>Trading High IV & Low IV Setups</li>
                                                        <li>IV Crush</li>
                                                    </ul>

                                                    <h4>5. Option Greeks (MOST IMPORTANT) </h4>
                                                    <ul>
                                                        <li>Basic Greeks</li>
                                                        <li>Delta</li>
                                                        <li>Gamma</li>
                                                        ...
                                                        <li>Delta Hedging</li>
                                                        <li>Gamma Scalping </li>
                                                        <li>Gamma Risk</li>
                                                        <li>Theta Decay Analysis</li>
                                                        <li>Vega Exposure</li>
                                                        <li>Greek Interrelationship</li>
                                                        <li>Portfolio Greeks</li>
                                                        <li>Greeks Adjustment Techniques</li>
                                                    </ul>

                                                    <h4>6. Option Pricing & Models</h4>
                                                    <ul>
                                                        <li>Intrinsic Value</li>
                                                        <li>Time Value</li>
                                                        <li>Option Premium Components</li>
                                                        <li>Black-Scholes Model </li>
                                                        <li>Binomial Model </li>
                                                        <li>Factors Affecting Option Premium</li>
                                                        <li>Option Chain Interpretation</li>
                                                    </ul>

                                                    <h4>7. Advanced Options Strategies</h4>
                                                    <ul>
                                                    ...
                                                    <h4>8. Pro-Level Multi-Leg Strategies</h4>
                                                    <ul>
                                                        <li>Iron Condor</li>
                                                        <li>Iron Butterfly</li>
                                                        <li>Ratio Spread</li>
                                                        ...
                                                        <li>Diagonal Spread</li>
                                                        <li>Jade Lizard </li>
                                                        <li>Broken Wing Butterfly </li>
                                                        <li>Double Calendar </li>
                                                    </ul>

                                                    <h4>9. Expiry & Adjustment Strategies</h4>
                                                    <ul>
                                                        <li>Expiry Week Behaviour</li>
                                                        <li>Max Pain Theory</li>
                                                        <li>Expiry Day Trading Setup</li>
                                                        <li>Rollover Analysis</li>
                                                        <li>Position Adjustment Techniques</li>
                                                        <li>Strategy Repair Techniques</li>
                                                        <li>Risk Adjustment During Expiry</li>
                                                    </ul>

                                                    <h4>10. Institutional & Sentiment Analysis</h4>
                                                    <ul>
                                                        <li>FII/DII Futures Positions</li>
                                                        <li>Client vs Pro Data</li>
                                                        <li>Market Wide Position Limits (MWPL)</li>
                                                        <li>Participant Wise OI Analysis</li>
                                                        <li>Sentiment Shifts Near Expiry</li>
                                                        <li>PCR Analysis</li>
                                                        <li>FII Long Short Ratio</li>
                                                    </ul>

                                                    <h4>11. Risk Management </h4>
                                                    <ul>
                                                        ...
                                                        <li>Maximum Loss Control</li>
                                                        <li>Psychological Discipline</li>
                                                    </ul>

                                                    <h4>12. Algorithmic & Quant Trading</h4>
                                                    <ul>
                                                        <li>Basics of Algo Trading</li>
                                                        <li>API Based Trading</li>
                                                        <li>Execution Algorithms</li>
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-3 col-xl-3 mt-4">
                            <div className='card msm-bg-color px-2 py-2 lw-card-color'>
                                <summary className='text-center text-white fw-bold text-uppercase p-3'>Modules 3 <br /> <small className='text-light msm-font-size'></small></summary>
                                <button type="button" class="btn-toggle-collapse msm-font-size-16px" data-bs-toggle="modal" data-bs-target="#exampleModal3">
                                    <b className='text-center msm-text-color-text'>Chapter 1</b> <br />
            ...
            <div className="bg-benefits-block-content">
                <div className="container pt-5">
                    <h1 className="fs-2 fw-bold text-white-heading text-center mb-5 text-uppercase">Course Benefits</h1>
                    ...
                    <div className="row msm-top-spacing justify-content-center">
                        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                            <div className="card text-center msm-bg-color">
                                <a href="https://wa.me/919834888821" target="_blank" rel="noopener noreferrer" className='text-decoration-none'>
                                    <FontAwesomeIcon icon={faSatelliteDish} className="msm-text-dark fs-3 m-auto mb-3" />
                                    <h6 className='fw-normal'>Pro Trading Setups in Live Sessions</h6>
                                </a>
                            </div>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                            <div className="card text-center msm-bg-color">
                                <a href="https://classplusapp.com/w/metta-share-market-fhxiz/courses/768258" target="_blank" rel="noopener noreferrer" className='text-decoration-none'>
