            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        ...
                        {/* heading */}
                        <h1 class="display-6 fw-bold text-white">Get Your Brochure</h1>
                        <p class=" text-light fw-normal mb-5 ">Submit the form to download the brochure and have our Academic Counselor reach out to you.</p>
                        {/* /heading */}
