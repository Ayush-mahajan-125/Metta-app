            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 msm-text-align">
                        ...
                        {/* description */}
                        <p className="msm-lead-description text-white">
                            <span className="text-warning fw-bold">Financial Investment & Trading Training Institute</span> is a premier education provider in stock market trading and investment strategies. Committed to building a new generation of skilled traders, MeTta offers comprehensive courses covering Stock Market Basics, Technical Analysis, Futures & Options, Commodities, Currencies, Risk & Money Management, and Trading Psychology.
